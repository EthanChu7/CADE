from generative_model.sagan import *
from generative_model.resnet import *
import torch.nn.init as init
from generative_model.causal_model import *
    ...
    def forward(self, x=None, z=None, recon=False, infer_mean=True):
        ...
        if x is not None and z is not None:
            ...
            if 'scm' in self.prior_dist:
                # in prior
                # print(z.shape, z[:, :self.num_label].shape)
        ...
        # Inference Mode
            ...
            # Representation
            # Mean representation for Gaussian xencoder
