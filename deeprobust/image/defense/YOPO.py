...
def load_checkpoint(file_name, net = None, optimizer = None, lr_scheduler = None):
    if os.path.isfile(file_name):
        print("=> loading ckpt_generative '{}'".format(file_name))
        ...
        print("=> no ckpt_generative found at '{}'".format(file_name))
...
def main():
    ...
    parser.add_argument('--resume', default=None, type=str, metavar='PATH',
                    help='path to latest ckpt_generative (default: none)')
    ...
    parser.add_argument('--auto-continue', default=False, action = 'store_true',
                        help = 'Continue from the latest ckpt_generative')
    ...
    if args.auto_continue:
        args.resume = os.path.join(args.model_dir, 'last.ckpt_generative')
    ...
    while True:
        ...
        utils.save_checkpoint(now_epoch, net, optimizer, lr_scheduler,
                        file_name = os.path.join(args.model_dir, 'epoch-{}.ckpt_generative'.format(now_epoch)))
